...
//   const savePin = () => {
//     if(title && title && body && imageAsset?._id && category){
//       const doc = {
//         _type: 'post',
//         title,
//         date,
...
//                   <option key={index} value={category.name} className='text-base border-0 outline-none capitalize bg-white text-black'>
//                     {category.name}
//                   </option>
//                 ))}
//               </select>
