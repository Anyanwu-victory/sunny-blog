       ...
       mt-10 space-y-3 md:space-y-4 '>
        ...
        <div className='flex flex-col'>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className='fill-emerald-600' 
             ...
             {/* instagram */}
           <span className='inline-flex mb-5 space-x-8 md:flex-col fill-emerald-600 md:space-y-8 md:space-x-0'>
              <Link to="@Black-rays">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
               fill="currentColor" className='fill-emerald-600 hover:fill-slate-700' 
               class="bi bi-twitter-x" viewBox="0 0 16 16">
                ...
                <Link>
                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
                     className="fill-emerald-600" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
